...
import 'package:weather_provider_app/views/cityentryview.dart';
import 'package:weather_provider_app/views/dailysummary.dart';
import 'package:weather_provider_app/views/lastupdatedview.dart';
import 'package:weather_provider_app/views/locationview.dart';
import 'package:weather_provider_app/views/weatherdescription.dart';
import 'package:weather_provider_app/views/weathersummary.dart';
                  ...
                  : weatherViewModel.isRequestError
                      ...
                      : Column(
                          children: [
                            ...
                            LastUpdatedView(
                                lastUpdatedOn: weatherViewModel.lastUpdated),
                          ],
                        )
            ],
          ),
  ...
  Widget buildDailySummary(List<Weather> dailyForecast) {
    return Row(
        ...
        children: dailyForecast
            .map((item) => new DailySummaryView(weather: item))
            .toList());
  }
